...
function save_signature_settings()
{
  ...
  if (user_info_str)
  {
	...
	Office.context.roamingSettings.set('newMail', "templateA");
	Office.context.roamingSettings.set('reply', "templateB");
	Office.context.roamingSettings.set('forward', "templateB");
